...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.encoder = nn.LSTM(
            embed_size, hidden_size, bias=True, bidirectional=True
        )  ## LTSM
        self.decoder = nn.LSTMCell(
            (embed_size + hidden_size), hidden_size, bias=True
        )  ##LTSMCELL
        ...
        self.dropout = nn.Dropout(self.dropout_rate)  ## dropout
        ### END YOUR CODE
    ...
    def encode(
        ...
        x = self.model_embeddings.source(source_padded)  # tensor of X
